...
description: Remove AI writing patterns from prose. Write, rewrite, audit, or edit files in place. Use this skill when writing, drafting, editing, reviewing, or revising any text to eliminate predictable AI tells, slop, and formulaic patterns. Trigger whenever the user asks to "deslop", "de-AI", "humanize", "make it sound human," "remove AI patterns," "remove AI-isms," "remove AI tropes," "clean up AI writing," "audit for AI tells," "detect AI patterns," "scan this," fix "slop," or review prose for authenticity. Also use when the user asks you to write or draft anything and wants it to sound natural rather than AI-generated. If asked to update, maintain, refresh, or check this skill's sources, follow references/maintenance.md. Covers scientific writing, blog posts, newsletters, memos, reports, social posts, product docs, and UI microcopy. NOT for visual or interface design critique (use a design review skill) and NOT for code, comments, or commit messages.
---
