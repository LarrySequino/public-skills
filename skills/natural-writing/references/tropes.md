...
The short quoted specimens of bad writing throughout this file are illustrative
examples, quoted for criticism. Several are drawn from Wikipedia's
[Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing),
which is CC BY-SA 4.0. See ATTRIBUTION.md.
